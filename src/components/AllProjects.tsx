...
<div className="w-8/12 hidden lg:block -z-0 bg-[#A3F8F0] h-[2px] absolute -right-2 top-1/2 -translate-y-1/2">
     <div className="w-4 h-4 bg-white rounded-full border-[2px] border-[#A3F8F0] absolute right-0 bottom-1/2 translate-y-1/2"></div>
      ...
      <div className="lg:w-2/4 md:w-[90%] w-ful flex flex-col  lg:mt-3 md:mt-9 px-5">
<h1 className="text-3xl font-bold text-[#A3F8F0] mt-5 mb-3">PokeHub</h1>
<span className="text-xl font-se text-[#A3F8F0] ">(All Pokemons Info)</span>
...
<ul className="flex w-full flex-wrap gap-4 mt-5">
<li className="text-[13px] px-3 py-2 border-[1px] rounded-2xl ">#ReactJs</li>
<li className="text-[13px] px-3 py-2 border-[1px] rounded-2xl">#NodeJs</li>
<li className="text-[13px] px-3 py-2 border-[1px] rounded-2xl">#Appwrite</li>
<li className="text-[13px] px-3 py-2 border-[1px] rounded-2xl">#TailwindCss</li>
<li className="text-[13px] px-3 py-2 border-[1px] rounded-2xl">#ReduxToolKit</li>
          </ul>
      </div>
     </div>
...
{/* 2nd */}
     <div className="w-full flex items-center lg:flex-nowrap flex-wrap-reverse">
     <div className="lg:w-2/4 w-full mt-3 px-5">
<h1 className="text-3xl font-bold text-[#fc815c] mt-5 mb-3">Hariguru</h1>
<span className="text-xl font-se text-[#fc815c] ">(Event Booking)</span>
<p className="text-lg mt-5">
HariGurus is a one-stop-shop for all Hindu religious, customs and traditional requirements. Built the complete site from scratch.
</p>
          <ul className="flex w-full flex-wrap gap-4 mt-5">
